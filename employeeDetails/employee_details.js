...
function findEmployeeById(employeeId) {
 ...
 function findEmployeeBySpecialization(employeeSpecialization) {
    ...
    document.getElementById('employeesDetails').innerHTML =`<p>${foundEmployeeSpecialization.id}: ${foundEmployeeSpecialization.name} - ${foundEmployeeSpecialization.department} - ${foundEmployeeSpecialization.specialization} - $${foundEmployeeSpecialization.salary}</p>`;
    }
    else{
